...
proc init_gui { IPINST } {
	...
	set tabgroup0 [ipgui::add_group $IPINST -parent $Page0 -name {s axi fir io (AXI4Lite Slave Interface)} -layout vertical]
	set C_S_AXI_FIR_IO_ADDR_WIDTH [ipgui::add_param $IPINST -parent $tabgroup0 -name C_S_AXI_FIR_IO_ADDR_WIDTH]
}
