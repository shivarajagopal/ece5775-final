...
set ID 3
set MemName voicerec_preprocessSound_begins
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename inSound \
    op interface \
    ports { inSound_address0 { O 14 vector } inSound_ce0 { O 1 bit } inSound_we0 { O 1 bit } inSound_d0 { O 32 vector } inSound_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'inSound'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename outSound \
    op interface \
    ports { outSound_address0 { O 13 vector } outSound_ce0 { O 1 bit } outSound_we0 { O 1 bit } outSound_d0 { O 32 vector } } \
} "
} else {
