set C_TypeInfoList {{ 
"voicerec" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"inSound": [[], {"array": [ {"scalar": "float"}, [16000]]}] }],["0","1","2","3","4","5","6","7","8"],""],
...
set C_modelArgMapList {[ 
	{ "Name" : "inSound", "interface" : "memory", "bitwidth" : 32 ,"direction" : "READWRITE" ,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "inSound","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 15999,"step" : 1}]}]}]} , 
