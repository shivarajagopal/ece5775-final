set C_TypeInfoList {{ 
"voicerec" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"inSound": [[], {"array": [ {"scalar": "float"}, [16000]]}] }],["0","1","2","3","4","5","6"],""],
 "0": [ "input", [[], {"array": [ {"scalar": "float"}, [883]]}],""],
 "1": [ "hidden", [[], {"array": [ {"scalar": "float"}, [26]]}],""],
 "2": [ "output", [[], {"array": [ {"scalar": "float"}, [4]]}],""],
 "3": [ "c", [[], {"array": [ {"scalar": "float"}, [512]]}],""],
 "4": [ "d", [[], {"array": [ {"scalar": "float"}, [256]]}],""],
 "5": [ "e", [[], {"array": [ {"scalar": "float"}, [26]]}],""],
 "6": [ "result", [[], {"array": [ {"scalar": "float"}, [63,14]]}],""]
}}
...
set C_modelArgList { 
	{ voicerec_inSound float 64 regular {axi_master 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "voicerec_inSound", "interface" : "axi_master", "bitwidth" : 64 ,"direction" : "READWRITE" ,"bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "inSound","cData": "float","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 15999,"step" : 1}]}]}]} , 
