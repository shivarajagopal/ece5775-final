...
set C_modelArgMapList {[ 
	{ "Name" : "sp", "interface" : "wire", "bitwidth" : 13 ,"direction" : "READONLY" } , 
 	...
 	{ "Name" : "tmp_133", "interface" : "wire", "bitwidth" : 6 ,"direction" : "READONLY" } , 
...
set portList { 
	...
	{ tmp_133 sc_in sc_lv 6 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_133", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "tmp_133", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	tmp_133 { ap_none {  { tmp_133 in_data 0 6 } } }
