...
set C_modelArgList { 
	...
	{ tmp_105 int 6 regular  }
	{ inputSound float 32 regular {array 8000 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sp", "interface" : "wire", "bitwidth" : 13} , 
 	{ "Name" : "ret", "interface" : "memory", "bitwidth" : 32} , 
 	{ "Name" : "tmp_105", "interface" : "wire", "bitwidth" : 6} , 
 	{ "Name" : "inputSound", "interface" : "memory", "bitwidth" : 32} ]}
...
set portList { 
	...
	{ tmp_105 sc_in sc_lv 6 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_105", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "tmp_105", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	tmp_105 { ap_none {  { tmp_105 in_data 0 6 } } }
