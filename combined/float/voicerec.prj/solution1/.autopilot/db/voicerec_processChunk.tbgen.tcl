...
set C_modelArgList { 
	{ sp int 13 regular  }
	{ ret float 64 regular {array 882 { 0 3 } 0 1 }  }
	{ tmp int 6 regular  }
	{ inputSound float 64 regular {array 8000 { 1 3 } 1 1 }  }
}
