...
entity voicerec_voicerec_inSound_m_axi is
    generic (
...
end entity voicerec_voicerec_inSound_m_axi;

architecture behave of voicerec_voicerec_inSound_m_axi is
    component voicerec_voicerec_inSound_m_axi_write is
        generic (
            C_M_AXI_ID_WIDTH      : INTEGER := 1;
            C_M_AXI_ADDR_WIDTH    : INTEGER := 32;
            C_TARGET_ADDR   : INTEGER := 16#00000000#;
    ...
    end component voicerec_voicerec_inSound_m_axi_write;

    component voicerec_voicerec_inSound_m_axi_read is
        generic (
            C_M_AXI_ID_WIDTH      : INTEGER := 1;
            C_M_AXI_ADDR_WIDTH    : INTEGER := 32;
            C_TARGET_ADDR   : INTEGER := 16#00000000#;
    ...
    end component voicerec_voicerec_inSound_m_axi_read;
...
begin
    ...
    -- Instantiation
    bus_write : voicerec_voicerec_inSound_m_axi_write
        generic map (
    ...
    bus_read : voicerec_voicerec_inSound_m_axi_read
        generic map (
            C_M_AXI_ID_WIDTH     => C_M_AXI_ID_WIDTH,
            C_M_AXI_ADDR_WIDTH   => C_M_AXI_ADDR_WIDTH,
            C_TARGET_ADDR  => C_TARGET_ADDR,
...
entity voicerec_voicerec_inSound_m_axi_fifo is
    generic (
        DATA_BITS   : INTEGER := 8;
        DEPTH       : INTEGER := 16;
...
end entity voicerec_voicerec_inSound_m_axi_fifo;

architecture behave of voicerec_voicerec_inSound_m_axi_fifo is
...
entity voicerec_voicerec_inSound_m_axi_decoder is
    generic (
        DIN_WIDTH : integer := 3);
    port (
        din     : in  UNSIGNED(DIN_WIDTH - 1 downto 0);
        dout    : out UNSIGNED(2**DIN_WIDTH - 1 downto 0));
end entity voicerec_voicerec_inSound_m_axi_decoder;

architecture behav of voicerec_voicerec_inSound_m_axi_decoder is
begin
    process (din)
    begin
        dout <= (others => '0');
...
entity voicerec_voicerec_inSound_m_axi_read is
    generic (
        C_M_AXI_ID_WIDTH      : INTEGER := 1;
        C_M_AXI_ADDR_WIDTH    : INTEGER := 32;
        C_TARGET_ADDR   : INTEGER := 16#00000000#;
...
end entity voicerec_voicerec_inSound_m_axi_read;

architecture behave of voicerec_voicerec_inSound_m_axi_read is
    --common
    ...
    component voicerec_voicerec_inSound_m_axi_fifo is
        generic (
            DATA_BITS   : INTEGER := 8;
            DEPTH       : INTEGER := 16;
            DEPTH_BITS  : INTEGER := 4);
        port (
            ...
            q           : out UNSIGNED(DATA_BITS-1 downto 0);
            data        : in  UNSIGNED(DATA_BITS-1 downto 0));
    end component voicerec_voicerec_inSound_m_axi_fifo;

begin
    --------------------------- AR channel begin -----------------------------------
    -- Instantiation
    fifo_rreq : voicerec_voicerec_inSound_m_axi_fifo
        generic map (
    ...
    --------------------------- R channel begin ------------------------------------
    -- Instantiation
    fifo_rdata : voicerec_voicerec_inSound_m_axi_fifo
        generic map (
    ...
    begin
        -- instantiation
        fifo_burst : voicerec_voicerec_inSound_m_axi_fifo
            generic map (
...
entity voicerec_voicerec_inSound_m_axi_write is
    generic (
        C_M_AXI_ID_WIDTH      : INTEGER := 1;
        C_M_AXI_ADDR_WIDTH    : INTEGER := 32;
        C_TARGET_ADDR   : INTEGER := 16#00000000#;
...
end entity voicerec_voicerec_inSound_m_axi_write;

architecture behave of voicerec_voicerec_inSound_m_axi_write is
    --common
    constant USER_DATA_WIDTH      : INTEGER := calc_data_width(USER_DW);
    constant USER_DATA_BYTES      : INTEGER := USER_DATA_WIDTH / 8;
    constant USER_ADDR_ALIGN      : INTEGER := log2(USER_DATA_BYTES);
...
begin
    --------------------------- AW channel begin -----------------------------------
    -- Instantiation
    fifo_wreq : voicerec_voicerec_inSound_m_axi_fifo
        generic map (
            DATA_BITS       =>  USER_AW + 32,
            DEPTH           =>  USER_MAXREQS,
            DEPTH_BITS      =>  log2(USER_MAXREQS))
    ...
    --------------------------- W channel begin ------------------------------------
    -- Instantiation
    fifo_wdata : voicerec_voicerec_inSound_m_axi_fifo
        generic map (
    ...
    bus_wide_gen : if (USER_DATA_WIDTH < BUS_DATA_WIDTH) generate
        ...
        component voicerec_voicerec_inSound_m_axi_decoder is
            generic (
                DIN_WIDTH : integer := 3);
            port (
                din     : in  UNSIGNED(DIN_WIDTH - 1 downto 0);
                dout    : out UNSIGNED(2**DIN_WIDTH - 1 downto 0));
        end component voicerec_voicerec_inSound_m_axi_decoder;
    ...
    begin
        ...
        head_pad_decoder : voicerec_voicerec_inSound_m_axi_decoder
            generic map (
                DIN_WIDTH       =>  PAD_ALIGN)
            port map (
                din             =>  head_pads,
        ...
        tail_pad_decoder : voicerec_voicerec_inSound_m_axi_decoder
            generic map (
                DIN_WIDTH       =>  PAD_ALIGN)
            port map (
                din             =>  tail_pads,
    ...
    --------------------------- B channel begin ------------------------------------
    -- Instantiation
    fifo_resp : voicerec_voicerec_inSound_m_axi_fifo
        generic map (
    ...
    fifo_resp_to_user : voicerec_voicerec_inSound_m_axi_fifo
        generic map (
            DATA_BITS       =>  2,
            DEPTH           =>  USER_MAXREQS,
            DEPTH_BITS      =>  log2(USER_MAXREQS))
