...
#ifndef __voicerec_sdiv_11ns_32ns_32_15_seq__HH__
#define __voicerec_sdiv_11ns_32ns_32_15_seq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(voicerec_sdiv_11ns_32ns_32_15_seq) {
    ...
    ACMP_sdiv_seq<ID, 15, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(voicerec_sdiv_11ns_32ns_32_15_seq):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
