...
module voicerec_voicerec_inSound_m_axi
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
...
//------------------------Instantiation------------------
// voicerec_voicerec_inSound_m_axi_write
voicerec_voicerec_inSound_m_axi_write #(
...
// voicerec_voicerec_inSound_m_axi_read
voicerec_voicerec_inSound_m_axi_read #(
    .C_M_AXI_ID_WIDTH        ( C_M_AXI_ID_WIDTH ),
    .C_M_AXI_ADDR_WIDTH      ( C_M_AXI_ADDR_WIDTH ),
    .C_TARGET_ADDR     ( C_TARGET_ADDR ),
...
module voicerec_voicerec_inSound_m_axi_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module voicerec_voicerec_inSound_m_axi_decoder
#(parameter
    DIN_WIDTH       = 3
)(
...
module voicerec_voicerec_inSound_m_axi_read
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
    C_M_AXI_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------AR channel begin---------------
//------------------------Instantiation------------------
    voicerec_voicerec_inSound_m_axi_fifo #(
...
module voicerec_voicerec_inSound_m_axi_write
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
    C_M_AXI_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------Body---------------------------
    ...
    if (USER_DATA_WIDTH == BUS_DATA_WIDTH) begin : bus_equal_gen
        ...
        voicerec_voicerec_inSound_m_axi_decoder #(
            .DIN_WIDTH(PAD_ALIGN)
        ) head_pad_decoder (
            .din(head_pads),
            .dout(head_pad_sel));
