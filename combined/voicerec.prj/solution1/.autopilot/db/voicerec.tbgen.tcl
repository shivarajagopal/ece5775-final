set C_TypeInfoList {{ 
"voicerec" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"np": [[], {"scalar": "int"}] }, {"inSound": [[], {"array": [ {"scalar": "double"}, [16000]]}] }],["0","1","2","3","4","5","6"],""],
...
set C_modelArgMapList {[ 
	{ "Name" : "np", "interface" : "wire", "bitwidth" : 32 ,"direction" : "READONLY" ,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "np","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ np sc_in sc_lv 32 signal 0 } 
	{ inSound_address0 sc_out sc_lv 14 signal 1 } 
	{ inSound_ce0 sc_out sc_logic 1 signal 1 } 
	{ inSound_we0 sc_out sc_logic 1 signal 1 } 
	{ inSound_d0 sc_out sc_lv 64 signal 1 } 
	{ inSound_q0 sc_in sc_lv 64 signal 1 } 
